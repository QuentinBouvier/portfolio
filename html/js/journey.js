...
var FloatingText = /** @class */ (function () {
    function FloatingText(name, text, position) {
        ...
        fontLoader.load('/TsTuto/src/res/Lato_Thin_Regular.json', function (response) {
...
$(document).ready(function () {
    ...
    var game, hello = new Portfolioscene_1.PortfolioScene('portfolio', 'cube', rendererOptions, new Camera_1.Camera(cameraOptions));
    hello.launch();
    ...
    function addJourneyInfos() {
        ...
        infos.innerHTML = 'Appuyez sur r ou Esc pour quitter<br>';
        infos.innerHTML += '<i class="fa fa-keyboard-o" aria-hidden="true"></i> ZQSD pour bouger<br>';
        infos.innerHTML += '<i class="fa fa-arrow-left" aria-hidden="true"></i>🖯<i class="fa fa-arrow-right" aria-hidden="true"></i>pour observer';
